...
import { calculateCategoryTotals, calculateMonthlyData, calculateDailyData } from '../utils/chartCalculations'
...
export const useChartData = (filteredExpenses, gastos, ingresos, filters) => {
  ...
  const generateChartData = useCallback(() => {
    ...
    // Gráfico de línea (últimos 30 días o por mes)
    let lineData
    if (filters.period === 'quarter' || filters.period === 'year') {
      // Gráfico por meses
