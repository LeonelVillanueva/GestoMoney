      ...
      <div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-zinc-800/50 dark:bg-slate-700 rounded-lg">
            <div>
              <div className="text-sm font-medium text-zinc-100 dark:text-gray-200">Activar notificaciones</div>
              <div className="text-xs text-zinc-400 dark:text-gray-400">Mostrar notificaciones del sistema</div>
            </div>
          ...
          <div className="flex items-center justify-between p-3 bg-zinc-800/50 dark:bg-slate-700 rounded-lg">
            <div>
              <div className="text-sm font-medium text-zinc-100 dark:text-gray-200">Sonido</div>
              <div className="text-xs text-zinc-400 dark:text-gray-400">Reproducir sonido al mostrar notificaciones</div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
          ...
          <div>
            <label className="block text-xs font-medium text-zinc-300 dark:text-gray-300 mb-1">Frecuencia de recordatorios</label>
            <select value={settings.reminderFrequency} onChange={(e) => onSettingChange('reminderFrequency', e.target.value)} className="w-full px-3 py-2 text-sm border border-zinc-600 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-zinc-900 dark:bg-slate-700 text-gray-900 dark:text-gray-100">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-medium text-zinc-300 dark:text-gray-300 mb-1">Duración (seg)</label>
              <select value={settings.notificationDuration} onChange={(e) => onSettingChange('notificationDuration', parseInt(e.target.value))} className="w-full px-3 py-2 text-sm border border-zinc-600 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-zinc-900 dark:bg-slate-700 text-gray-900 dark:text-gray-100">
